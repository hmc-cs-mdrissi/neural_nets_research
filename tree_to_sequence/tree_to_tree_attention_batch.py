...
class TreeToTreeAttentionBatch(nn.Module):
    ...
    def get_next_decoder_input(self, next_input, et):
        ...
        """ 
        return torch.cat((self.embedding(next_input.unsqueeze(1)), et), 2)
    ...
    def get_next_child_states(self, parent, child_index, input, hidden_state, cell_state): # should be decoder specific
        ...
        """
        # torchfold needs an extra dimension
    ...
    def forward_train(self, input_tree_list, target_tree_list):
        ...
        fold3 = Fold()
        losses = [self.decode(fold3, hidden, cell_state, tree, -1, 0, annotation) for annotation, hidden, cell_state, tree in zip(annotations, hiddens, cell_states, target_tree_list)]
        
        computed_losses = fold3.apply(self, [losses])[0]
        print("done")
    ...
    def decode(self, fold, decoder_hiddens, decoder_cell_states, targetNode, parent_val, child_index, annotations): 
        ...
        """
#         print("decoder starting!!!", decoder_hiddens.shape, decoder_cell_states.shape, targetNode.value.shape, annotations.shape)
